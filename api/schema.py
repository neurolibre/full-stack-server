...
class DownloadSchema(Schema):
    ...
    is_overwrite = fields.Boolean(required=False,description="Whether or not the downloaded data will overwrite, if already exists.")
    external_repo = fields.Str(required=False,description="A non-review repo.")
